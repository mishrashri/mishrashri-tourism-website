      ...
      <div className="subComponent-lg" id="footerBody">
        <Container>
          ...
          <footer className="svg-group text-center">
            <Row>
              <Col md="3" xs="6">
                <div className="svg-card-3">
                  <a href="https://www.facebook.com/narayan.mishra.5074">
              ...
              <Col md="3" xs="6">
                <div className="svg-card-3">
                  <a href="https://twitter.com/mishrashrihere">
              ...
              <Col md="3" xs="6">
                <div className="svg-card-3">
                  <a href="https://www.linkedin.com/in/narayan-mishra-b25657170/">
              ...
              <Col md="3" xs="6">
                <div className="svg-card-3">
                  <a href="https://www.instagram.com/mishrashrihere/">
            ...
            <hr />
            <br />
            <p>copyright 2021 | Mishrashri Tourism Barsana</p>
          </footer>
        </Container>
      </div>
    );
